    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-8">
          ...
          {/* Aviso sobre foto pós-pagamento */}
          <section className="rounded-2xl border border-blue-300 bg-blue-50 p-5 dark:border-blue-700 dark:bg-blue-950/30">
            <div className="flex items-start gap-3">
              <span className="text-xl leading-none mt-0.5">ℹ️</span>
              <div>
                <p className="font-semibold text-blue-900 dark:text-blue-300">Foto será solicitada após pagamento</p>
                <p className="mt-1 text-sm text-blue-800 dark:text-blue-400">
                  Após confirmar o pagamento, você será solicitado a enviar uma foto biométrica (selfie) do titular para acesso ao evento.
                </p>
              </div>
            </div>
          </section>
